    ...
    <div className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-surface-container-high">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-on-surface headline">The Digital Boulangerie</h1>
          <p className="text-on-surface-variant text-sm mt-2">Entre na sua conta para gerenciar sua confeitaria</p>
        </div>
