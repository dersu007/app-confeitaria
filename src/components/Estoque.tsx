          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[1000px]">
              ...
              <tbody className="divide-y divide-surface-container-high">
                {loadingInsumos ? (
                  <tr><td colSpan={9} className="py-20 text-center"><Loader2 className="animate-spin text-primary mx-auto" size={40} /></td></tr>
                ) : filteredInsumos.map((insumo, idx) => {
                  const isCritical = insumo.estoque_atual <= insumo.estoque_minimo;
                  return (
        ...
        <div className="bg-white rounded-3xl border border-surface-container-high shadow-sm overflow-hidden animate-in fade-in duration-300">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-surface-container-high">
                {loadingMovs ? (
                  <tr><td colSpan={5} className="py-20 text-center"><Loader2 className="animate-spin text-primary mx-auto" size={32} /></td></tr>
